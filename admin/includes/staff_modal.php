    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="staff_add.php">
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="password" name="password" placeholder="Default Password:12345"disabled>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="staff_delete.php">
                <input type="hidden" class="staffid" name="id">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="staff_edit_photo.php" enctype="multipart/form-data">
                <input type="hidden" class="staffid" name="id">
                <div class="form-group">
