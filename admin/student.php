        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn w3-button label-success btn-sm btn-flat"><i class="fa fa-plus"></i> New Student</a>
            </div>
            <div class="box-body">
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                     ...
                     // $photo = "../images/peng.jpg";
                      echo "
                        <tr>
                          <td>".$row['code']."</td>
                          <td>
                            <img src='".$photo."' width='30px' height='30px'>
                            <a href='#edit_photo' data-toggle='modal' class=' pull-right photo' data-id='".$row['studid']."'><span class='fa fa-upload'></span></a>
                          </td>
