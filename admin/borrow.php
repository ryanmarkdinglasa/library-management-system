        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn w3-button label-success w3-border-radius btn-sm btn-flat"><i class="fa fa-plus"></i> Borrow</a>
            </div>
            <div class="box-body">
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
						  if($row['barstat']){
							$status = '<div  class="label label-success w3-button" ><span>returned</span></div>';
						  }
						  else{
							$status = '<div  class="label label-danger w3-button" ><span>not returned</span></div>';
						  }
					  $dateToday=date("Y-m-d");
					  if($row['barstat'] =="0" && $row['returnDate']<$dateToday){
