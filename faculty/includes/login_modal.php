<!-- Login -->
<div class="modal fade" id="login" style="color:#000;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn w3-button label-success btn-flat" name="login"><i class="fa fa-sign-in"></i> Login</button>
              </form>
            </div>
        </div>
    </div>
